...
- `MUST` treat `SKILL.md` as the canonical source for operational rules and trigger behavior.
- `SHOULD` keep skills simple unless automation is explicitly required.
- `SHOULD` keep output quality rules precise and user-facing.
